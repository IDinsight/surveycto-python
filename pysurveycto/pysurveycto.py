...
class SurveyCTOObject(object):
    ...
    def __check_date_and_raise(self,
        ...
        if ((format == 'csv') & (oldest_completion_date is not None)):
            ...
            if not (isinstance(oldest_completion_date, datetime.date) or isinstance(oldest_completion_date, datetime.datetime)):
    ...
    def __get_url_date(self,
        ...
        url_date = quote(oldest_completion_date.strftime(
            "%b %-d, %Y %-I:%M:%S %p"))
